  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-royal-blue via-[#1a1a4b] to-[#2d1b4d] relative">
      <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl p-10 overflow-hidden relative">
        ...
        {error && (
          <div className="mb-5 p-3 bg-red-50 border-l-4 border-red-500 text-red-700 text-[10px] font-bold uppercase tracking-widest animate-pulse">
            ⚠️ {error}
          </div>
        )}
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5 ml-1">
              <label className="block text-[10px] font-black text-royal-blue uppercase tracking-widest flex items-center">
          ...
          <button 
            type="submit" 
            className="w-full bg-royal-blue text-white py-4 rounded-xl font-black uppercase text-xs tracking-[0.4em] shadow-xl hover:bg-neon-pink transition-all active:scale-95"
          >
            login
          </button>
        </form>
